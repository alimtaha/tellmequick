      ...
      <body className="overflow-x-hidden">
        ...
        >
          <header className="fixed top-0 left-0 z-50 hidden w-full flex-row items-center justify-between p-6 md:flex">
            <a href="/" className="flex items-center gap-2" aria-label={`${companyName} home`}>
              <span
                className="size-2.5 rounded-full"
                style={{ background: 'var(--context)' }}
                aria-hidden
              />
              <span className="text-foreground font-mono text-sm font-bold tracking-tight lowercase">
                {companyName}
              </span>
            </a>
          </header>
